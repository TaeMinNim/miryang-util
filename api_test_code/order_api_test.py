    ...
    'orders': [
        {
            ...
            'groups': [
                {
                    'group_id': 1665508590283,
                    'options': [1665508592345, 1665508617919, 1665508624756]
                },
                {
                    'group_id': 1665508644904,
                    'options': [1665508646961]
                }
            ]
        },
        {
            ...
            'groups': [
                {
                    'group_id': 1665508715971,
                    'options': [1665508718034]
                }
            ]
        }
    ]
...
#202
#res = requests.get('http://localhost:5000/order/menu/list?store_id=6345a45f1c32cd7c4b64d895', headers=loginheader)

#203
#res = requests.get('http://localhost:5000/order/menu/detail?store_id=6345a45f1c32cd7c4b64d895&menu_name=딥치즈버거', headers=loginheader)

#204
#res = requests.post('http://localhost:5000/order/post/posting', headers=loginheader, json=posting)

#205
res = requests.get('http://localhost:5000/order/post/detail/634e8af7b829facb9e6239e8', headers=loginheader)
...
#210
#GET
#res = requests.get('http://localhost:5000/order/ordering/update?post_id=6345aa7b911ed10ac4cde368', headers=loginheader)
#PATCH
